...
class PetSerializer(serializers.ModelSerializer):
    ...
    additionalPhoto = serializers.ImageField(source='additional_image', required=False)
    additionalPhoto_url = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "additionalPhoto": {"write_only": True}
        }
    ...
    def get_additionalPhoto(self, obj):
